...
const Navbar = () => {
    ...
    function randleRotation() {
        ...
        if (isRotated) {
            ...
            // Menu aberto
            if (indexes.classList.contains('animate-slide-out')) {
                indexes.classList.remove('animate-slide-out');
            }
            if (!indexes.classList.contains('animate-slide-in')) {
                indexes.classList.add('animate-slide-in');
            }
            if (indexes.classList.contains('hidden')) {
                indexes.classList.remove('hidden');
            }
            nav_bar.style.overflow = 'auto';
