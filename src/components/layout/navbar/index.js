            ...
            <section className={'w-full h-full flex'}>
                ...
                <section className={'w-1/5 h-full'}>
                    <div className={`mb-w-1/5 h-full flex justify-center items-end`}>
                        ...
                        {/* WHATSAPP DESKTOP */}
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className={"bi bi-whatsapp mb-4 hover:cursor-pointer lg:block hidden"} viewBox="0 0 16 16">
