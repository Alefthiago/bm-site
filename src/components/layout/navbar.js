...
let div_text_style = 'w-1/4 flex justify-center mb-3 items-end';
// Styles //
        ...
        <nav className={'w-full h-[90px] bg-[#206BA5]'}>
            <section className={'w-full h-full flex'}>
                <div className={'w-1/5 h-full flex justify-center items-end'}>
                    <div className={'mb-3'}>
                        <Image src={'/Teal.png'} alt={'Logo BM Informatica'} width={60} height={60} />
                    </div>
                </div>
                <div className={'w-3/5 h-full container mx-auto columns-sm flex items-end gap-2 text-[#E0E0E0] roboto-bold'}>
