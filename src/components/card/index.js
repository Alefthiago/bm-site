        ...
        <section>
            <div className="container px-6 py-10 mx-auto">
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                    {props.cardsData.map((card, index) => (
                        <div key={index} className={`invisible ${index <= 2 || (index > 5 && index < 9) ? 'show-right' : 'show-left'} drop-shadow-xl w-full max-w-sm bg-white rounded-lg shadow-lg hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer`}>
