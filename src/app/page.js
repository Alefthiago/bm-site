...
export default function Home() {
  ...
  return (
    <section className={`${Globals.default_style_page}`}>
          ...
          <div className="container px-6 py-12 mx-auto">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer">
                ...
                <h1 className="mt-4 text-xl font-semibold">Aplicativos Mobile e Desktop</h1>

                <p className="mt-2 text-gray-500">Programas desenvolvidos para realizar tarefas específicas em smartphones, tablets e computadores. Eles são projetados para serem fáceis de usar e adaptar às necessidades dos usuários.</p>
              </div>
              ...
              <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer">
                ...
                <h1 className="mt-4 text-xl font-semibold">Computação em Nuvem</h1>

                <p className="mt-2 text-gray-500">A computação em nuvem, ou cloud computing, permite acessar aplicativos e dados pela internet de qualquer lugar e em qualquer dispositivo, da mesma forma que se estivessem instalados no seu computador local. Em vez de armazenar tudo no seu próprio hardware, você usa recursos e serviços disponíveis online.</p>
              </div>
          ...
          <div className="container px-6 py-10 mx-auto">
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-1 lg:grid-cols-2">
              {cardDt.map((card, index) => (
                ...
                <div key={index} className="overflow-hidden bg-white rounded-lg shadow-lg hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer">
                  ...
                  <div className="flex items-center justify-between px-4 py-2 bg-gray-900">
                    ...
                    <button className="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-300 transform bg-white rounded hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">Contato</button>
                  </div>
                </div>
                // <Card
                //   key={index}
                //   imgSrc={card.imgSrc}
                //   renderImage={() => <Image width={500} height={100} src={card.imgSrc}/>}
                // >
      ...
      <div className="divider-bottom w-full bg-[#F8F8F8]">
        <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
          <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" className="shape-fill"></path>
        </svg>
      </div>
      ...
      <section className="w-full bg-transparent">
        <section className="container lg:w-3/5 px-6 mx-auto">
          <div className="container px-6 py-10 mx-auto">
            <h1 className="text-2xl font-semibold text-center text-[#206BA5] capitalize lg:text-4xl">Emissão Facilitada e Segura de <br /><span> Documentos Fiscais Eletrônicos</span></h1>
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-2">
              {cardSN.map((card, index) => (
                <div key={index} className="flex flex-col items-center p-6 space-y-3 text-center bg-[#206BA5] rounded-xl hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer">
                  ...
                  <h1 className="text-xl font-semibold text-[#f8f8f8] capitalize">{card.texto}</h1>

                  <p className="text-[#f8f8f8]">{card.desc}</p>
