            ...
            <div className="flex flex-col lg:flex-row items-center">
              <div className="w-full lg:w-1/2">
                <div className="lg:max-w-lg px-2">
                  <h1 className="text-3xl inter-bold lg:text-4xl animate-fade-right">
                    A Melhor Solução para o Seu Negocio aqui<br />
                    <span className="text-blue-500">BM INFORMATICA</span>
                  </h1>
                  <p className="mt-3 text-gray-600 raleway-regular animate-fade-right">
                    Nossos profissionais, especialistas em várias áreas criam soluções que transformam seu dia a dia.
                  </p>
                  <button className="animate-fade-right inter-regular w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none transition-transform duration-500 ease-in-out transform hover:scale-105">
                    Contratar
                  </button>
                </div>
              </div>
              <div className="lg:flex hidden items-center justify-center w-full lg:w-1/2 mt-6 lg:mt-0 hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer animate-fade-left">
            ...
            <section>
              <div className="container px-6 py-12 mx-auto ">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                  <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer animate-fade-right">
                  ...
                  <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer animate-fade-up">
                  ...
                  <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer animate-fade-left">
                    <svg className="w-8 h-8" viewBox="0 0 30 30" fill="none">
