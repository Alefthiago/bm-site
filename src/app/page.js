            ...
            <section>
              <div className="container px-6 py-12 mx-auto ">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                  <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer show-right">
                  ...
                  <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer show-top">
                  ...
                  <div className="hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer show-left">
                    <svg className="w-8 h-8" viewBox="0 0 30 30" fill="none">
              ...
              <div className="container px-6 py-10 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-1 lg:grid-cols-2">
                  {cardDt.map((card, index) => (
                    ...
                    <div key={index} className={`${index == 0 ? 'show-right' : 'show-left'} overflow-hidden h-auto bg-gray-900 rounded-lg shadow-lg hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer`}>
              ...
              <div className="container px-6 py-10 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-2">
                  {cardSN.map((card, index) => (
                    <div key={index} className={`${index == 0 || index == 2 ? 'show-right' : 'show-left'} flex flex-col items-center p-6 space-y-3 text-center bg-[#206BA5] rounded-xl hover:scale-105 transition-transform duration-500 ease-in-out hover:cursor-pointer`}>
