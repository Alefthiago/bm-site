            ...
            <section className=" flex justify-between pt-12 ">
                <section className="text-justify pt-12 pr-2 w-full content-center">
                    <div className="pl-5 flex flex-col justify-center items-center gap-5" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star-fill size-8 text-[#208da5] " viewBox="0 0 16 16">
                ...
                <section className="text-justify w-full ">
                    <div className="pl-5 flex flex-col justify-center items-center gap-5" >
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-eye-fill  size-10 text-[#208da5]  " viewBox="0 0 16 16">
                ...
                <section className="text-justify pt-12 pl-2 content-center w-full">
                    <div className="pl-5 flex flex-col justify-center items-center gap-5 ">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bar-chart-fill size-10 text-[#208da5] " viewBox="0 0 16 16">
