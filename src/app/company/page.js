...
let container_empresa = "flex flex-row justify-between  w-full max-w-screen-lg lg:w-[1000px]  w-[900px] overflow-hidden";
...
const pageCompany = () => {
    ...
    return (
        <section className="flex min-h-screen flex-col items-center pt-10 gap-12 ">
            ...
            <section className="w-[60%] md:overflow-hidden">
